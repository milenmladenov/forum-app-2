...
public class Post implements Serializable {
   ...
   public Post(Integer id, String title, String content, int voteCount, Integer userId) {
      this.id = id;
      this.title = title;
   ...
   @Override
   public int hashCode() {
      return Objects.hash(getId(), getTitle(), getContent(), getUserName(), getVoteCount(), getUserId(), getPostedAt(), getUpdatedAt(), getComments());
}
   @Override
